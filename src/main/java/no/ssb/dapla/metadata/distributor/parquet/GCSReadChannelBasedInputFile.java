...
public class GCSReadChannelBasedInputFile implements InputFile {
    ...
    public SeekableInputStream newStream() throws IOException {
        return new GCSReadChannelSeekableInputStream();
    }

    @Override
    public String toString() {
        return "GCSReadChannelBasedInputFile[" + readChannel.toString() + "]";
    }

    class GCSReadChannelSeekableInputStream extends SeekableInputStream {
        long pos = 0;
